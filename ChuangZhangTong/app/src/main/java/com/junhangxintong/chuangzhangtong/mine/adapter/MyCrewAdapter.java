package com.junhangxintong.chuangzhangtong.mine.adapter;
...
import com.junhangxintong.chuangzhangtong.mine.activity.CertificateListsActivity;
...
public class MyCrewAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            holder.tvItemCrewName = (TextView) convertView.findViewById(R.id.tv_item_crew_name);
            holder.tvItemCrewDuty = (TextView) convertView.findViewById(R.id.tv_item_crew_duty);
            holder.tvItemCrewJobNum = (TextView) convertView.findViewById(R.id.tv_item_crew_job_num);
            holder.tvItemCrewNationality = (TextView) convertView.findViewById(R.id.tv_item_crew_nationality);
