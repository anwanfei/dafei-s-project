package com.junhangxintong.chuangzhangtong.shipposition.adapter;
...
public class ShipMessagesAdapter extends BaseAdapter {

    private Context mContext;
    private List<String> messages;
    private ViewHolder viewHolder;

    public ShipMessagesAdapter(Context mContext, List<String> messages) {
