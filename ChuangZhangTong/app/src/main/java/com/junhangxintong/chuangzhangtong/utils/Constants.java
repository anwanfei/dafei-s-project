package com.junhangxintong.chuangzhangtong.utils;
...
public class Constants {
    ...
    public static final String EMERGENCY_CONTACTOR = "emergency_contactor";
    public static final String EMERGENCY_CONTACTOR_PHONE = "emergency_contactor_phone";
