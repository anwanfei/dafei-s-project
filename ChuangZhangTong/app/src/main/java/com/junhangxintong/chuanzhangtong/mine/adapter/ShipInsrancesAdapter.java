...
public class ShipInsrancesAdapter extends BaseAdapter {

    private Context mContext;
    private List<CustomCertificateBean> certificates;

    public ShipInsrancesAdapter(Context mContext, List<CustomCertificateBean> myFleetLists) {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        String certifNo = certificates.get(position).getShipName();
