...
/**
 * Created by anwanfei on 2017/10/9.
 */
...
public class TileSystem {
    ...
    public static int MapSize(int levelOfDetail) {
        return (int) Math.abs(256 << levelOfDetail);
    ...
    public static void LatLongToPixelXY(double latitude, double longitude, int levelOfDetail, int pixelX, int pixelY) {
        latitude = Clip(latitude, MinLatitude, MaxLatitude);
    ...
    public static void PixelXYToTileXY(int pixelX, int pixelY, int tileX, int tileY) {
        tileX = pixelX / 256;
        tileY = pixelY / 256;
    }
    ...
    public static void TileXYToPixelXY(int tileX, int tileY, int pixelX, int pixelY) {
        pixelX = tileX * 256;
        pixelY = tileY * 256;
    }
    ...
    public static void QuadKeyToTileXY(String quadKey, int tileX, int tileY, int levelOfDetail) {
        tileX = tileY = 0;
