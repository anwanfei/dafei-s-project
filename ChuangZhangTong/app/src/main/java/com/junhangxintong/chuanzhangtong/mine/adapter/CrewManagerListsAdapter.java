...
public class CrewManagerListsAdapter extends BaseAdapter {
    ...
    public CrewManagerListsAdapter(Context mContext, List<CrewServeBean.DataBean.ArrayBean> myFleetLists) {
